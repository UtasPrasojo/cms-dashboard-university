<template>
    <svg id="fi_2657972" enable-background="new 0 0 512.392 512.392" height="512" viewBox="0 0 512.392 512.392"
        width="512" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
        <g>
            <path
